  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        <CustomButton 
          btnType="button"
          title={address ? address.toString().substring(0,5)+' . . . '+address.toString().substring(address.toString().length-5) : 'Connect'}
          styles={address ? 'bg-[#1dc071] text-ellipsis overflow-hidden' : 'bg-[#8c6dfd]'}
          handleClick={() => {
